...
void LevelingBilinear::print_leveling_grid(const element_2d_fn* _z_values /*= NULL*/) {
  // print internal grid(s) or just the one passed as a parameter
  SERIAL_ECHOLNPGM("Bilinear Leveling Grid:");
  print_2d_array(GRID_MAX_POINTS_X, GRID_MAX_POINTS_Y, 3, z_values ? *_z_values[0] : _z_values[0]);
